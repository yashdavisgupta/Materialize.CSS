...
if( !class_exists( 'nandgatestudios_core' ) ){

class nandgatestudios_core
{
    /* AUTHOR */
    static function author( $key )
    {
        $cfgs = nandgatestudios_cfg::get( 'author' );
    ...
    {
        $cfgs = nandgatestudios_cfg::get( 'theme' );
    ...
    {
        $cfgs = nandgatestudios_cfg::get( 'links' );
