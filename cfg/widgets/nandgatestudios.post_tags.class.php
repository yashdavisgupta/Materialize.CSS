<?php
if( !class_exists( 'nandgatestudios_post_tags' ) ){

class nandgatestudios_post_tags extends WP_Widget
{
    function __construct()
    {
        parent::__construct( 'nandgatestudios_post_tags', __( 'Post Tags' , 'materialize' ) . ' [' . nandgatestudios_core::author( 'name' ) . ']', array( 
...
register_widget( 'nandgatestudios_post_tags' );
