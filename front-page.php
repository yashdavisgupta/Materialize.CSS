...
?>
            ...
            <div class="nandgatestudios-white nandgatestudios-front-page-header-sidebars">

                <!-- the header front page sidebars content -->
                <div class="content">
                    <div class="container">

                        <aside class="row nandgatestudios-header-items">
        ...
        <div class="row">
            ...
            <?php
                ...
                if( $is_front_page ){
                    ...
                    // get layout details
                    $nandgatestudios_layout = new nandgatestudios_layout( 'front-page' );
            ...
            ?>
                    ...
                    <?php
                        ...
                        if( count( $wp_query -> posts ) ){
                            ...
                            $classes = implode( ' ' , get_post_class( 'nandgatestudios-page' , absint( get_option( 'page_on_front' ) ) ) );
