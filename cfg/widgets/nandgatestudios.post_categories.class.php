<?php
if( !class_exists( 'nandgatestudios_post_categories' ) ){

class nandgatestudios_post_categories extends WP_Widget
{
    function __construct()
    {
        parent::__construct( 'nandgatestudios_post_categories', __( 'Post Categories' , 'materialize' ) . ' [' . nandgatestudios_core::author( 'name' ) . ']', array( 
...
register_widget( 'nandgatestudios_post_categories' );
