...
if( comments_open() ){
    ...
    if ( have_comments() ) {
        ...
        echo '<div class="nandgatestudios-comments">';
        ...
        wp_list_comments( array(
            'callback' => array( 'nandgatestudios_comments' , 'classic' ),
            'style' => 'ul' 
        ));
        ...
        $args = array(
            'echo'      => false,
            'prev_text' => sprintf( __( '%s Prev' , 'materialize' ) , '<i class="nandgatestudios-icon-left-open-1"></i>' ),
            'next_text' => sprintf( __( 'Next %s' , 'materialize' ) , '<i class="nandgatestudios-icon-right-open-1"></i>' )
        );
        ...
        if( !empty( $pgn ) ){
            ...
            echo '<nav class="nandgatestudios-nav-inline">';
            echo $pgn;
            echo '</nav>';
            echo '</div>';    
        }
    ...
    if( (bool)get_theme_mod( 'nandgatestudios-html-suggestions', true ) ){
        $rett .= '<div class="nandgatestudios-html-suggestions">';
