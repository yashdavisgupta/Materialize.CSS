                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col s12">
                            ...
                            <nav class="nandgatestudios-navigation">
                              <ul>
                                ...
                                <?php
                                    ...
                                    if( !empty( $categories ) ){
                                        ...
                                        foreach( $categories as $c ){
                                            echo nandgatestudios_breadcrumbs::categories( absint( $c -> term_id ) );
                                            break;
                                        }
                                    }
                                ?>
    ...
    <div class="content">
        ...
        <div class="container">
            ...
            <?php
                ...
                // get layout details
                $nandgatestudios_layout = new nandgatestudios_layout( 'post' );
            ...
            ?>
                ...
                ?>
                            ...
                            <?php
                                ...
                                wp_link_pages( array(
                                    'before'        => '<div class="nandgatestudios-paged-post"><span class="nandgatestudios-pagination-title">' . __( 'Pages', 'materialize' ) . ': </span>',
