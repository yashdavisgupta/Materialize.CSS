<?php
if( !class_exists( 'nandgatestudios_tools' ) ){
    
class nandgatestudios_tools
{
    /* WEB RESOURCES */
        ...
        if( !empty( $pages ) ){
            ...
            foreach( $pages as $p => $item ){
                ...
                if( is_page( $item -> ID ) ){
                    ...
                    $nandgatestudios_curr_ancestor = true;
                }
                ...
                $rett .= '<a href="' . esc_url( get_permalink( $item -> ID ) ) . '" title="' . nandgatestudios_post::title( $item -> ID, true ) . '">' . nandgatestudios_post::title( $item -> ID ) . '</a>';
